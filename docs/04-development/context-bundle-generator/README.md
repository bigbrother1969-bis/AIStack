...
Any verification of documentation integration, architectural principles, or project knowledge shall always be performed against the latest available bundle unless an explicit historical comparison is requested.

This rule guarantees that every reasoning process is based on the most up-to-date governed knowledge heritage.
